...
export interface ApiContestContest extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    accessLevel: Schema.Attribute.Enumeration<['VIP', 'Normal']>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    prize_histories: Schema.Attribute.Relation<
      'oneToMany',
      'api::prize-history.prize-history'
    >;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiPrizeHistoryPrizeHistory
  extends Struct.CollectionTypeSchema {
...
export interface ApiQuestionQuestion extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    type: Schema.Attribute.Enumeration<['Single', 'Multi', 'TrueFalse']>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::prize-history.prize-history': ApiPrizeHistoryPrizeHistory;
